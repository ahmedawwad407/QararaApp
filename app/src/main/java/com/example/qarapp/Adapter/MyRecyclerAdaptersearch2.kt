...
import com.example.qarapp.Admin.MyBillScreenAdmin
import com.example.qarapp.R
import com.example.qarapp.models.MyModel2
import com.google.firebase.firestore.FirebaseFirestore
import kotlinx.android.synthetic.main.item_payment.view.*

class MyRecyclerAdaptersearch2(val context: Context, val list: ArrayList<MyModel2>) :
    RecyclerView.Adapter<MyRecyclerAdaptersearch2.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvProductName.setOnClickListener {
            var intent = Intent(context, MyBillScreenAdmin::class.java)
